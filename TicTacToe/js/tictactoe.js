...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'O') {
            //This funciton disables clicking for computer turn.
            disableClick();
    ...
    function computersTurn() {
        //This boolean is needed forour while loop.
        let success = false;
...
function checkWinConditions() {
    ...
    // X 0, 4, 8 condition.
    else if (arrayIncludes('0X', '4X', '8X')) {drawWinLine(100, 100, 558, 100) }
    // O 0, 1, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indeciates where the start of a lines x axis is.
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temperary y axis data we update in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        c.lineWidth = 10;
        //This method draws everythign we laid out above.
        c.stroke();
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This veriable gets the HTML element i.
